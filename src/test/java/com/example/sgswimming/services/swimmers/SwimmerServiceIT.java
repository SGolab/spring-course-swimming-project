...
public class SwimmerServiceIT {
    ...
    void findAll() {
        ...
        swimmerReadDtoList.forEach(Assertions::assertNotNull);
        swimmerReadDtoList.forEach(dto -> assertFalse(dto.getLessons().isEmpty()));
        swimmerReadDtoList.forEach(dto -> assertTrue(dto
                .getLessons()
                .stream()
